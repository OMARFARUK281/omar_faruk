  ...
  return (
    <div style={{borderRadius: '0 100px 0px 100px'}} className="bg-zinc-500 p-12 mb-4 ">
      <ul>
        ...
        <button className="text-2xl p-2 mr-2 bg-orange-600 text-white rounded">Backend</button>
        <button className="text-2xl p-2 bg-orange-600 text-white rounded">Tools</button>
      </ul>
